...
import com.bytebeats.classloader.sample.util.IoUtils;
 ...
 *
 * @author Ricky Fung
 * @create 2017-03-12 17:52
 */
public class ExtensionClassLoader {
    private final Logger logger = LoggerFactory.getLogger(ExtensionClassLoader.class);

    private URLClassLoader classLoader;

    public ExtensionClassLoader(String jarfileDir){
        this(new File(jarfileDir), null);
    }
    public ExtensionClassLoader(File jarfileDir){
        this(jarfileDir, null);
    }
    public ExtensionClassLoader(File jarfileDir, ClassLoader parent) {
